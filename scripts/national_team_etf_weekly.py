...
WATCHLIST: tuple[WatchETF, ...] = (
    # Core broad-index ETFs disclosed in Central Huijin / Huijin AM ETF holdings.
    ...
    WatchETF("510100", "上证50ETF易方达", "上证50", "SSE"),
    WatchETF("510180", "上证180ETF华安", "上证180", "SSE"),
    WatchETF("510230", "金融ETF国泰", "上证180金融", "SSE"),
    WatchETF("510500", "中证500ETF南方", "中证500", "SSE"),
    WatchETF("512500", "中证500ETF华夏", "中证500", "SSE"),
    WatchETF("159922", "中证500ETF嘉实", "中证500", "SZSE"),
    WatchETF("515800", "中证800ETF汇添富", "中证800", "SSE"),
    WatchETF("512100", "中证1000ETF南方", "中证1000", "SSE"),
    WatchETF("159845", "中证1000ETF华夏", "中证1000", "SZSE"),
    WatchETF("560010", "中证1000ETF广发", "中证1000", "SSE"),
    WatchETF("159629", "中证1000ETF富国", "中证1000", "SZSE"),
    WatchETF("159915", "创业板ETF易方达", "创业板", "SZSE"),
    WatchETF("159952", "创业板ETF广发", "创业板", "SZSE"),
    WatchETF("159977", "创业板ETF天弘", "创业板", "SZSE"),
    WatchETF("159901", "深证100ETF易方达", "深证100", "SZSE"),
    WatchETF("588080", "科创50ETF易方达", "科创50", "SSE"),
    WatchETF("588050", "科创50ETF工银", "科创50", "SSE"),
    WatchETF("588000", "科创50ETF华夏", "科创50", "SSE"),
    WatchETF("560050", "中国A50ETF汇添富", "MSCI中国A50", "SSE"),
    # Additional A500 observation names from the user's ETF radar screenshot.
